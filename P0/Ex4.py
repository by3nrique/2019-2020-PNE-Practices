...
for file in files_list:  # We go throw every file in the list , U5 , ADA...
    ...
    print("Gene " + file)  # Print the Gene used
    for base in bases:  # Go throw every base in bases
        print(base + ": ", seq_count_base(sequence, base))  # seq_count_base() This function counts just one base
